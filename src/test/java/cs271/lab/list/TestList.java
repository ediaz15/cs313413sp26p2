...
public class TestList {
  ...
  public void setUp() throws Exception {
    ...
    //it doesnt seem like it given that the tests pass
  }
  ...
  public void testRemoveObject() {
    ...
    //The method above remove() goes to that index and removes the value from there, it should be the default value of an array 0?
    // TODO fix the expected values in the assertions below
    assertEquals(6, list.size());//post testing it looks like it removes it too
    assertEquals(1, list.indexOf(77));
    assertEquals(3, list.lastIndexOf(77));
    assertEquals(4, list.get(2).intValue());
    assertEquals(77, list.get(3).intValue());
    list.remove(Integer.valueOf(5)); // TODO Question: What does this one do?
    //i think it gets the first value of int 5 then removes it from the list
    assertEquals(5, list.size()); //i dont think the size of the array changes -> it does
    assertEquals(1, list.indexOf(77));
    assertEquals(3, list.lastIndexOf(77));
    assertEquals(4, list.get(2).intValue());
    assertEquals(77, list.get(3).intValue());
